...
export class ToastService {
	...
	/**
	 * @param { string } titulo Default 'Información'. titulo Cabecera del toast.
	 * @param { string } cuerpo Default 'Este es un mensaje de información'. cuerpo Cuerpo del toast.
	 * @param { string } tipo Default 'info'. tipo Tipo del mensaje. Opciones disponibles: info, success, danger. 
